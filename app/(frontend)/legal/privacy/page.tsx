  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <section className="mb-12">
        ...
        <p className="mb-4">
          We collect information you provide directly to us, such as when you create an account, subscribe to our newsletter, fill out a form, request customer support, or otherwise communicate with us. This information may include your name, email address, phone number, company name, job title, and any other information you choose to provide. We refer to this as &quot;Account Information&quot; or &quot;Contact Information&quot;.
        </p>
        <p className="mb-4">
          We do not sell your personal information. We may share your information with third-party service providers who perform services on our behalf, such as payment processing, data analysis, email delivery, hosting services, customer service, and marketing assistance. These service providers are authorized to use your personal information only as necessary to provide these services to us. We require such third parties to agree to keep your information confidential and use it only for the purposes for which we disclose it to them. We won&apos;t share your data without explicit consent unless legally required.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <p className="mb-4">
          When you use our services or contact us, we may collect personally identifiable information, such as your name, email address, telephone number, and company name. This information is collected on a voluntary basis when you provide it to us.
        </p>
      ...
      <section className="mb-12">
        ...
        <h3 className="mb-2 text-xl font-semibold">By Law or to Protect Rights</h3>
        <p className="mb-4">
          If we believe the release of information about you is necessary to respond to legal process, to investigate or remedy potential violations of our policies, or to protect the rights, property, and safety of others, we may share your information as permitted or required by any applicable law, rule, or regulation.
        </p>
        <h3 className="mb-2 text-xl font-semibold">Third-Party Service Providers</h3>
        <p className="mb-4">
