        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl text-white">Terms of Service</h1>
          ...
          <div className="mx-auto max-w-3xl space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p>
                ...
                prior written consent of CyberShield.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold">Links To Other Web Sites</h2>
              <p>
            ...
            <div className="space-y-4">
              ...
              <p>
                In no event shall CyberShield, nor its directors, employees, partners, agents, suppliers, or affiliates,
