        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/services/security-audits" className="text-muted-foreground hover:text-foreground">
                  Security Audits
                </Link>
              </li>
              <li>
                <Link href="/services/incident-response" className="text-muted-foreground hover:text-foreground">
                  Incident Response
                </Link>
              </li>
              <li>
                <Link href="/services/security-training" className="text-muted-foreground hover:text-foreground">
                  Security Training
                </Link>
              </li>
            </ul>
